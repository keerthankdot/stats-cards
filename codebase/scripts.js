...
(function() {
  ...
  // ── Reviews ──
  const REVIEWS = [
    { name: 'Kunal Shah',      city: 'Bengaluru', quote: '"Incredible experience. The mattress adapts perfectly to my body shape — I would 100% recommend it! Changed my sleep completely."',                                                                        img: '11-testimonials/kunal.jpeg',   bodyBefore: '11-testimonials/before.png', bodyAfter: '11-testimonials/after.png' },
    ...
    { name: 'Abhishek J R',    city: 'Bengaluru', quote: '"My Calibr8 mattress is so comfortable, stays cool, and has improved my sleep experience immensely! Worth every single penny."',                                                                      img: '11-testimonials/abhishekphoto.png', bodyBefore: '11-testimonials/abhishek_nobg.png', bodyAfter: '11-testimonials/purab2_nobg.png' },
  ];
