(() => {
  ...
  // ── Solution section: heroGIF.mp4 last-5s loop ──
  {
    ...
    if (sv) {
      const loopStart = () => Math.max(0, sv.duration - 6);
      sv.addEventListener('loadedmetadata', () => {
        sv.currentTime = loopStart();
        sv.play().catch(() => {});
      });
...
(function() {
  ...
  const CARDS = [
    ...
    { id: 1, title: 'Heat Map', desc: 'Your body pressure appears in real time from Blue to Red, revealing where it\'s building up.', img: null, video: '../05-process/heatmap.mp4', icon: heatmapIcon('#ffffff') },
    { id: 2, title: 'Calibration', desc: 'Calibr8 reconfigures the middle support layer, until your body\'s 8 zones find perfect support.', img: null, video: '../05-process/Calibration.mp4', icon: calibrationIcon('#ffffff') },
    ...
    { id: 4, title: 'Mattress Type', desc: 'Choose between memory foam, latex or grid as the preferred top layer for your Calibr8ed mattress.', img: null, video: '../05-process/layers.mp4', icon: mattressIcon('#ffffff') },
    { id: 5, title: 'Your Mattress', desc: 'A one-of-a-kind personalised mattress designed with Calibr8 is delivered to your home.', img: null, video: '../05-process/Final Mattress.mp4', icon: mattressIcon('#ffffff') },
  ];
  ...
  const PROCESS_CARDS_DESKTOP = [
    { id: 0, eyebrow: 'The Pain Sufferer',    title: 'Waking up with body pain shouldn\'t be your normal.',     desc: 'Targeted support relieves the pressure points across your back, shoulders, hips & joints.',           video: '../02-pain/pain.mp4' },
    ...
    { id: 2, eyebrow: 'The Couple',           title: 'Two people Completely different needs',                 desc: 'Each side is calibr8ed independently, so both of you get the support your body needs.',               video: '../07-people/couple.mp4' },
    { id: 3, eyebrow: 'The High Achiever',    title: 'You train hard Hustle hard Push your body every day',  desc: 'Calibr8ed support helps your body recover deeper, so you wake up ready to do it all again.',           video: '../07-people/lift.mp4' },
  ...
  const PROCESS_CARDS_MOBILE = [
    { id: 0, eyebrow: 'The Pain Sufferer', title: '',  desc: 'Targeted support relieves the pain across your back, shoulders, hips & joints while you sleep.',                    video: '../02-pain/pain.mp4' },
    ...
    { id: 2, eyebrow: 'The Couple',        title: '',  desc: 'Each side is calibrated independently, to support two people with different needs.',                                   video: '../07-people/couple.mp4' },
    { id: 3, eyebrow: 'The High Achiever', title: '',  desc: 'As you train hard, Calibr8ed support helps your body recover better through the night.',                             video: '../07-people/lift.mp4' },
